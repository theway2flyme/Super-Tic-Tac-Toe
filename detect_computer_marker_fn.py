def detect_computer_marker(coordinate, coordinate_board, board):
    row_count_2 = 0
    value_count_2 = 0
    ...
    def left_checker(coordinate, board, coordinate_board):
        ...
        if len(b_value) >= 1 and len(a_value) >= 1:
           value_1 = b_value[3] + '_' + a_value[3]
           if board[row_count_3 - 1][value_1] == computer_marker:
                tic_tac_toe_check += 1
        if len(b_value) >= 2 and len(a_value) >= 2:
            value_2 = b_value[2] + '_' + a_value[2]
            if board[row_count_3 - 1][value_2] == computer_marker:
                tic_tac_toe_check += 1
        if len(b_value) >= 3 and len(a_value) >= 3:
            value_3 = b_value[1] + '_' + a_value[1]
            if board[row_count_3 - 1][value_3] == computer_marker:
                tic_tac_toe_check += 1
        if len(b_value) >= 4 and len(a_value) >= 1:
            value_4 = b_value[0] + '_' + a_value[0]
            if board[row_count_3 - 1][value_4] == computer_marker:
                tic_tac_toe_check += 1
        return tic_tac_toe_check
    ...
    def l_l_checker(coordinate, board, coordinate_board):
        ...
        if len(b_value) >= 1 and len(a_value) >= 1:
            value_4 = b_value[0] + '_' + a_value[0]
            if board[row_count_3][value_4] == computer_marker:
                tic_tac_toe_check += 1
        if len(b_value) >= 2 and len(a_value) >= 2:
            value_3 = b_value[1] + '_' + a_value[1]
            if board[row_count_3 + 1][value_3] == computer_marker:
        ...
        if len(b_value) >= 3 and len(a_value) >= 3:
            value_2 = b_value[2] + '_' + a_value[2]
            if board[row_count_3 + 2][value_2] == computer_marker:
                tic_tac_toe_check += 1
        if len(b_value) >= 4 and len(a_value) >= 1:
            value_1 = b_value[3] + '_' + a_value[3]
            if board[row_count_3 + 3][value_1] == computer_marker:
                tic_tac_toe_check += 1
        return tic_tac_toe_check
    ...
    def bottom_checker(coordinate, board, coordinate_board):
        ...
        if len(b_value) >= 1 and len(a_value) >= 1:
            value_1 = b_value[0] + '_' + a_value[0]
            if board[row_count_3][value_1] == computer_marker:
                tic_tac_toe_check += 1
        if len(b_value) >= 2 and len(a_value) >= 2:
            value_2 = b_value[1] + '_' + a_value[1]
            if board[row_count_3 + 1][value_2] == computer_marker:
        ...
        if len(b_value) >= 3 and len(a_value) >= 3:
            value_3 = b_value[2] + '_' + a_value[2]
            if board[row_count_3 + 2][value_3] == computer_marker:
                tic_tac_toe_check += 1
        if len(b_value) >= 4 and len(a_value) >= 1:
            value_4 = b_value[3] + '_' + a_value[3]
            if board[row_count_3 + 3][value_4] == computer_marker:
                tic_tac_toe_check += 1
        return tic_tac_toe_check
